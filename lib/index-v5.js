...
const _isInteger = _interopDefault(require('lodash/isInteger'))
const _maxBy = _interopDefault(require('lodash/maxBy'))
const _filter = _interopDefault(require('lodash/filter'))
const _head = _interopDefault(require('lodash/head'))
...
class Gang {
	constructor(members) {
		const primaryIndex = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false
...
class NSelector {
	constructor(matrix, selection) {
		const ns = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : uuid()
...
function createSelector(matrix) {
	const selection = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0
	const ns = arguments[2]
