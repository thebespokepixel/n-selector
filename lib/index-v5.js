...
class Gang {
	constructor(members) {
		let primaryIndex = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
...
class NSelector {
	constructor(matrix, selection) {
		let ns = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : uuid();
...
function createSelector(matrix) {
	let selection = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;
	let ns = arguments[2];
